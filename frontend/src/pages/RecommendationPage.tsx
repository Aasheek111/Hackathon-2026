          ...
          {recommendations.map((rec, i) => (
            ...
            >
              <div className="flex items-start justify-between flex-wrap gap-4 mb-4">
                <div>
                  ...
                  <p className="text-slate-500 text-xs font-medium">
                    Taught by {rec.classroom.teacherName}
                  </p>
                  {rec.classroom.description && (
              ...
              <div className="space-y-2 mb-6">
                ...
                {rec.reasons.filter((r) => r.applicable).length === 0 && (
                  <p className="text-xs text-slate-500">
                    This classroom has no specific admission criteria — open to
                    everyone.
                  </p>
                )}
              </div>
              ...
              <button
                ...
                disabled={
                  requestedIds.has(rec.classroom.id) ||
                  requesting === rec.classroom.id
                }
